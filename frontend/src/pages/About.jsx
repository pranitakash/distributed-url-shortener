  ...
  return (
    <div className="min-h-screen bg-white dark:bg-[#0a0a0a] transition-colors duration-300">
      ...
      <section className="max-w-4xl mx-auto px-6 py-16 space-y-8">
        <div>
          <h2 className="text-3xl font-bold text-gray-900 dark:text-gray-100 mb-4">Our Story</h2>
        ...
        <div>
          <h2 className="text-3xl font-bold text-gray-900 dark:text-gray-100 mb-4">What We Believe</h2>
        ...
        <div>
          <h2 className="text-3xl font-bold text-gray-900 dark:text-gray-100 mb-4">Built with</h2>
        ...
        <div className="border-t border-gray-200 dark:border-gray-800 pt-8">
          ...
          <div className="flex gap-6">
            <a href="https://www.linkedin.com/in/pranit-akash/" target="_blank" rel="noreferrer" className="text-green-600 dark:text-green-500 hover:text-green-700 dark:hover:text-green-400 font-semibold transition">
              LinkedIn →
            </a>
            <a href="mailto:pranit.dot.akash@gmail.com" className="text-green-600 dark:text-green-500 hover:text-green-700 dark:hover:text-green-400 font-semibold transition">
              Email →
            </a>
            <a href="https://instagram.com/pranit_akash" target="_blank" rel="noreferrer" className="text-green-600 dark:text-green-500 hover:text-green-700 dark:hover:text-green-400 font-semibold transition">
              Instagram →
            </a>
          </div>
        </div>
