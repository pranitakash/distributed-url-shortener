      ...
      <section className="max-w-4xl mx-auto px-6 py-16 space-y-8">
        ...
        <div className="border-t border-gray-200 pt-8">
          ...
          <div className="flex gap-6">
            <a href="https://www.linkedin.com/in/pranit-akash/" target="_blank" rel="noreferrer" className="text-green-600 hover:text-green-700 font-semibold transition">
              LinkedIn →
            </a>
            <a href="mailto:pranit.dot.akash@gmail.com" className="text-green-600 hover:text-green-700 font-semibold transition">
              Email →
            </a>
            <a href="https://instagram.com/pranit_akash" target="_blank" rel="noreferrer" className="text-green-600 hover:text-green-700 font-semibold transition">
              Instagram →
            </a>
          </div>
        </div>
